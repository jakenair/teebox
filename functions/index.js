...
// convertToWebp lives in ./lib/imageConvert so the optimizeListingPhoto trigger
// and scripts/backfill-heic.mjs share ONE implementation (no drift). It decodes
// JPEG/PNG/WebP/AVIF via sharp and Apple HEVC-HEIC via a heic-convert fallback,
// throwing IMG_DECODE_FAILED if neither can decode — see that file for detail.
const {convertToWebp} = require("./lib/imageConvert");
