...
export const COURSES = [
  ...
  },
  {
    ...
    name: 'Stonewall Links',
    shortName: 'Stonewall Links',
    aliases: ['stonewall', 'stonewall links'],
  ...
  // ── Added 2026-05-13 batch (Stage 5 pipeline) ────────────────────────────
  {
    id: 'atlanta-athletic-club',
    name: 'Atlanta Athletic Club',
    shortName: 'Atlanta Athletic',
    aliases: ['aac', 'atlanta ac'],
    location: 'Johns Creek, Georgia',
    architect: 'Robert Trent Jones Sr. (Highlands)',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'beverly-country-club',
  ...
  {
    id: 'biltmore-forest-country-club',
    name: 'Biltmore Forest Country Club',
    shortName: 'Biltmore Forest',
    aliases: [],
  ...
  {
    id: 'bluejack-national',
    name: 'Bluejack National',
    shortName: 'Bluejack National',
    aliases: ['bluejack'],
  ...
  {
    id: 'california-golf-club',
    name: 'California Golf Club of San Francisco',
    shortName: 'California Golf Club of San Francisco',
    aliases: ['cal club', 'cgc'],
    location: 'South San Francisco, California',
    architect: 'A.V. Macan; restored by Kyle Phillips',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'caves-valley-golf-club',
    name: 'Caves Valley Golf Club',
    shortName: 'Caves Valley',
    aliases: [],
  ...
  {
    id: 'charlotte-country-club',
    name: 'Charlotte Country Club',
    shortName: 'Charlotte',
    aliases: ['charlotte cc'],
    location: 'Charlotte, North Carolina',
    architect: 'Donald Ross (1925 redesign)',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'cherry-valley-club',
    name: 'Cherry Valley Club',
    shortName: 'Cherry Valley',
    aliases: [],
    location: 'Garden City, New York',
  ...
  {
    id: 'colorado-golf-club',
    name: 'Colorado Golf Club',
    shortName: 'Colorado',
    aliases: ['cgc'],
  ...
  {
    id: 'country-club-of-charleston',
    name: 'Country Club of Charleston',
    shortName: 'Country Club of Charleston',
    aliases: ['ccc', 'charleston cc'],
  ...
  {
    id: 'dedham-country-and-polo-club',
    name: 'Dedham Country and Polo Club',
    shortName: 'Dedham Country and Polo',
    aliases: ['dedham cc'],
  ...
  {
    id: 'east-potomac-golf-links',
    name: 'East Potomac Golf Links',
    shortName: 'East Potomac',
    aliases: [],
    location: 'Washington, District of Columbia',
    architect: 'Walter Travis (renovated by Gil Hanse 2024)',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'eastward-ho-country-club',
    name: 'Eastward Ho! Country Club',
    shortName: 'Eastward Ho!',
    aliases: ['eastward ho'],
  ...
  {
    id: 'floridian-national-golf-club',
    name: 'The Floridian National Golf Club',
    shortName: 'Floridian National',
    aliases: ['the floridian'],
    location: 'Palm City, Florida',
    architect: 'Gary Player (redesigned by Tom Fazio)',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'frederica-golf-club',
    name: 'Frederica Golf Club',
    shortName: 'Frederica',
    aliases: [],
    location: 'St. Simons Island, Georgia',
    architect: 'Tom Fazio',
  ...
  {
    id: 'gasparilla-golf-club',
    name: 'Gasparilla Golf Club',
    shortName: 'Gasparilla',
    aliases: ['gasparilla'],
    location: 'Boca Grande, Florida',
    architect: 'Pete Dye (renovation)',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'huntingdon-valley-country-club',
    name: 'Huntingdon Valley Country Club',
    shortName: 'Huntingdon Valley',
    aliases: ['hvcc'],
    location: 'Huntingdon Valley, Pennsylvania',
    architect: 'Willie Tucker / Donald Ross',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'jupiter-hills-club',
    name: 'Jupiter Hills Club',
    shortName: 'Jupiter Hills',
    aliases: [],
  ...
  {
    id: 'lake-merced-golf-club',
    name: 'Lake Merced Golf Club',
    shortName: 'Lake Merced',
    aliases: [],
    location: 'Daly City, California',
    architect: 'Willie Locke (renovated by Rees Jones)',
    logo: '',
    logoUrl: '',
  },
  {
  ...
  {
    id: 'north-berwick-golf-club',
    name: 'North Berwick Golf Club (West Links)',
    shortName: 'North Berwick Golf Club',
    aliases: ['north berwick', 'nbgc'],
    location: 'North Berwick, East Lothian',
    architect: 'Unknown (evolved over time)',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'old-memorial-golf-club',
    name: 'Old Memorial Golf Club',
    shortName: 'Old Memorial',
    aliases: [],
  ...
  {
    id: 'the-country-club-of-darien',
    name: 'The Country Club of Darien',
    shortName: 'Country Club of Darien',
    aliases: ['cc of darien'],
  ...
  },
  {
    ...
    shortName: 'Park West Palm',
    aliases: ['the park', 'the park west palm beach'],
  ...
  {
    id: 'the-tuxedo-club',
    name: 'The Tuxedo Club',
    shortName: 'The Tuxedo',
    aliases: ['tuxedo club'],
  ...
  {
    id: 'timuquana-country-club',
    name: 'Timuquana Country Club',
    shortName: 'Timuquana',
    aliases: ['timuquana cc'],
  ...
  {
    id: 'union-league-national',
    name: 'Union League National Golf Club',
    shortName: 'Union League National',
    aliases: ['uln'],
    location: 'Swainton, New Jersey',
    architect: 'Robert Trent Jones Jr. (renovated)',
    logo: '',
    logoUrl: '',
  },
  {
    id: 'watersound-club',
    name: 'Watersound Club',
    shortName: 'Watersound',
    aliases: ['camp creek', 'origins', 'sharks tooth'],
    location: 'Panama City Beach, Florida',
    architect: 'Tom Fazio / Davis Love III',
    logo: '',
    logoUrl: '',
  },
  {
  ...
  {
    id: 'wicker-point-golf-club',
    name: 'Wicker Point Golf Club',
    shortName: 'Wicker Point',
    aliases: [],
  ...
  {
    id: 'wilmington-country-club',
    name: 'Wilmington Country Club (South Course)',
    shortName: 'Wilmington Country Club',
    aliases: ['wilmington cc'],
  ...
  // Chicago-area clubs — PASSPORT ONLY (logos live in /assets/logos/passport/,
  // not /assets/logos/, so they are loggable in Course Passport but never
  // appear in Logo Bingo). Architects left as '—' pending confirmation;
  // founded years are read directly off the club marks.
  {
    id: 'bull-valley',
    name: 'Bull Valley Golf Club',
    shortName: 'Bull Valley',
    aliases: ['bull valley gc', 'bull valley'],
  ...
  },
  {
    id: 'merit-club',
    name: 'Merit Club',
    shortName: 'Merit Club',
    aliases: ['the merit club', 'merit'],
  ...
  {
    id: 'idlewild',
    name: 'Idlewild Country Club',
    shortName: 'Idlewild',
    aliases: ['idlewild cc', 'idlewild country club'],
    location: 'Flossmoor, Illinois',
    architect: '—',
    founded: 1908,
    logo: '',
  ...
  },
  {
    ...
    shortName: 'Conway Farms',
    aliases: ['conway farms gc', 'conway'],
  ...
  {
    id: 'rolling-green',
    name: 'Rolling Green Country Club',
    shortName: 'Rolling Green',
    aliases: ['rolling green cc', 'rolling green'],
  ...
  {
    id: 'evanston-golf-club',
    name: 'Evanston Golf Club',
    shortName: 'Evanston GC',
    aliases: ['evanston gc', 'evanston golf'],
  ...
  {
    id: 'skokie-cc',
    name: 'Skokie Country Club',
    shortName: 'Skokie CC',
    aliases: ['skokie cc', 'skokie country club'],
